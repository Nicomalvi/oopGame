...
No conoce el mapa ni otras entidades; únicamente almacena el estado físico necesario para que el sistema de físicas pueda actualizarla.
...
Conoce el MapGrid y las PhysicalEntity, aplica gravedad, mueve las entidades y actualiza la estructura espacial del mapa.
...
y una Behavior. Cada tick, el actor le ordena a la PhysEnt cómo moverse según lo dice su behavior. Ciertas acciones cambian
el State del actor, por ejemplo si estoy atacando durante 2 segundos no podré saltar o moverme.
...
Por ejemplo, la behavior del player simplemente lee el teclado para ver hacia dónde moverse o cuándo atacar.
